...
$(document).ready(function () {
    ...
    $('#frmHD').validate({
        ...
        messages: {
            'tenhd': {
                required: 'Phải nhập tên hướng dẫn!'
            }
        }
    });
    ...
    $('#frmHK').validate({
        ...
        messages: {
            'mancc': {
                required: 'Phải nhập mã!',
                maxlength: 'Mã nhà cung cấp tối đa 5 ký tự!'
            },
            'tenncc': {
                required: 'Phải nhập tên nhà cung cấp!'
            }
        }
    });
    ...
    $('#frmBiennhan').validate({
        ...
        messages: {
            'ngaydatcoc': {
                required: 'Phải nhập ngày biên nhận!'
            },
            'tenkhach': {
