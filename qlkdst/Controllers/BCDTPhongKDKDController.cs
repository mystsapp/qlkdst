...
namespace qlkdst.Controllers
{
    public class BCDTPhongKDKDController : BaseController
    {
        ...
        public ActionResult dtphongkdkd(string tungay, string denngay, string tungay1, string denngay1, string dlcn)
        {
        ...
        [HttpGet]
        public ActionResult Excel(string tungay, string denngay, string tungay1, string denngay1,string schinhanh)
        {
            ...
            var stream = CreateExcel(tungay, denngay,tungay1,denngay1, schinhanh);
        ...
        private Stream CreateExcel(string tungay, string denngay, string tungay1, string denngay1, string schinhanh, Stream stream = null)
        {
            DateTime d1 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-1-1");
            DateTime d2 = DateTime.Parse(DateTime.Now.AddDays(-365).ToString("yyyy") + "-12-31");
            ...
            using (var excelPackage = new ExcelPackage(stream ?? new MemoryStream()))
            {
                ...
                excelPackage.Workbook.Properties.Title = "BÁO CÁO DOANH THU THEO PHÒNG KINH DOANH KHÁCH ĐOÀN";
        ...
        public ExcelWorksheet FormatWorkSheet(DataSet ds, ExcelWorksheet ew, DateTime d1, DateTime d2)
        {
            ...
            ewres.Cells[2, 1].Value = "BÁO CÁO DOANH THU PHÒNG KINH DOANH KHÁCH ĐOÀN";
