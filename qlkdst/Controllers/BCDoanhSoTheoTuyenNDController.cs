...
namespace qlkdst.Controllers
{
    public class BCDoanhSoTheoTuyenNDController : BaseController
    {
        ...
        /// <summary>
        ///11092019: add loaitourid,nguontour     , nhung chua truyen vao, de do khi nao co yeu cau moi hien len gui
        /// </summary>
        /// <param name="tungay"></param>
        /// <param name="denngay"></param>
        /// <param name="dlcn"></param>
        /// <param name="loaitourid"></param>
        /// <returns></returns>
        ...
        private DataSet GetDuLieuBC(DateTime d1, DateTime d2, string schinhanh)
        {
            ...
            DataSet ds = dao.BCDTTheoTuyenND(d1, d2, Session["username"].ToString(), sRoles, schinhanh, sCongTyPre,"","");
        ...
        public ExcelWorksheet FormatWorkSheet(DataSet ds, ExcelWorksheet ew, DateTime d1, DateTime d2)
        {
            ...
            ewres.Cells[4, 10].LoadFromText("Loại tour");//add 11092019
