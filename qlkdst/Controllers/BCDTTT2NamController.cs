...
namespace qlkdst.Controllers
{
    public class BCDTTT2NamController : BaseController
    {
        ...
        public ActionResult Excel(string tuthang1, string denthang1, string nam1, string tuthang2, string denthang2, string nam2, string schinhanh)
        {
            ...
            string Filename = "BCSosanhdoanhsocacnam_" + System.DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".xlsx";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow row in distinctTuyen.Rows)
                {
                    ...
                    if (rows2.Length > 0)
                    {
                        ...
                        {
                            //dDoanhThu1 = @Decimal.Parse(r2["doanhthutt"].ToString() == "" ? "0" : r2["doanhthutt"].ToString());
                    ...
                    if (rows1.Length > 0)
                    {
                        ...
                        {
                            //dDoanhThu2 = @Decimal.Parse(r1["doanhthutt"].ToString() == "" ? "0" : r1["doanhthutt"].ToString());
